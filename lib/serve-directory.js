...
var style = fs.readFileSync(path.join(__dirname, '../public/style.css'), 'utf-8').trim();

var iconColor = '#6a737d';
var icons = {
  directory: '<svg xmlns="http://www.w3.org/2000/svg" height="16" viewBox="0 0 12 16" width="12"><path d="M13 4H7V3c0-.66-.31-1-1-1H1c-.55 0-1 .45-1 1v10c0 .55.45 1 1 1h12c.55 0 1-.45 1-1V5c0-.55-.45-1-1-1zM6 4H1V3h5v1z"></path></svg>',
  ...
  media: '<svg xmlns="http://www.w3.org/2000/svg" height="16" viewBox="0 0 12 16" width="12"><path d="M6 5h2v2H6V5zm6-.5V14c0 .55-.45 1-1 1H1c-.55 0-1-.45-1-1V2c0-.55.45-1 1-1h7.5L12 4.5zM11 5L8 2H1v11l3-5 2 4 2-2 3 3V5z"></path></svg>'
};
...
Object.keys(icons).map(function(icon) {
  style += '.file__icon_' + icon + '{background-image:' + makeSvg(icons[icon]) + '}'
})
